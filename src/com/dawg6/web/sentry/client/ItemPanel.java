...
public class ItemPanel extends Composite {
	...
	public ItemPanel() {
		...
		flexTable.setWidget(12, 0, anchor_6);
		
		bombadiers = new SimpleCheckBox();
		flexTable.setWidget(12, 1, bombadiers);
		...
		flexTable.setWidget(13, 0, anchor_13);
		
		vaxo = new SimpleCheckBox();
		flexTable.setWidget(13, 1, vaxo);
		...
		flexTable.setWidget(17, 3, odysseysEndUptime);
		...
		flexTable.setWidget(21, 0, label_15);
		...
		flexTable.setWidget(21, 1, areaDamageEquipment);
		...
		flexTable.setWidget(22, 0, label_1);
		...
		flexTable.setWidget(22, 1, eliteDamagePercent);
		...
		flexTable.setWidget(23, 0, lblNoteSubtract);
		flexTable.getFlexCellFormatter().setColSpan(23, 0, 4);
		...
		flexTable.getFlexCellFormatter().setColSpan(21, 0, 3);

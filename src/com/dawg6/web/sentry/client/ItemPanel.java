...
public class ItemPanel extends Composite {
	...
	public ItemPanel() {
		...
		flexTable.setWidget(10, 0, anchor_14);
		
		Label label_16 = new Label("# Pieces:");
		flexTable.setWidget(10, 1, label_16);
		
		numNats = new NumberSpinner();
		numNats.setVisibleLength(2);
		numNats.setText("6");
		flexTable.setWidget(10, 2, numNats);
		...
		flexTable.setWidget(11, 0, anchor_15);
		
		bastions = new SimpleCheckBox();
		flexTable.setWidget(11, 1, bastions);
		...
		flexTable.setWidget(12, 0, anchor_16);
		
		crashingRain = new SimpleCheckBox();
		flexTable.setWidget(12, 1, crashingRain);
		...
		flexTable.setWidget(13, 0, anchor_6);
		
		bombadiers = new SimpleCheckBox();
		flexTable.setWidget(13, 1, bombadiers);
		...
		flexTable.setWidget(14, 0, anchor_13);
		
		vaxo = new SimpleCheckBox();
		flexTable.setWidget(14, 1, vaxo);
		...
		flexTable.setWidget(18, 3, odysseysEndUptime);
		...
		flexTable.setWidget(22, 0, label_15);
		...
		flexTable.setWidget(22, 1, areaDamageEquipment);
		...
		flexTable.setWidget(23, 0, label_1);
		...
		flexTable.setWidget(23, 1, eliteDamagePercent);
		...
		flexTable.setWidget(24, 0, lblNoteSubtract);
		flexTable.getFlexCellFormatter().setColSpan(24, 0, 4);
		...
		flexTable.getFlexCellFormatter().setColSpan(22, 0, 3);

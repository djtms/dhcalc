...
public class ItemPanel extends Composite {
	...
	public ItemPanel() {
		...
		flexTable.setWidget(11, 0, anchor_6);
		
		bombadiers = new SimpleCheckBox();
		flexTable.setWidget(11, 1, bombadiers);
		...
		flexTable.setWidget(12, 0, anchor_13);
		
		vaxo = new SimpleCheckBox();
		flexTable.setWidget(12, 1, vaxo);
		...
		flexTable.setWidget(16, 3, odysseysEndUptime);
		...
		flexTable.setWidget(20, 0, label_15);
		...
		flexTable.setWidget(20, 1, areaDamageEquipment);
		...
		flexTable.setWidget(21, 0, label_1);
		...
		flexTable.setWidget(21, 1, eliteDamagePercent);
		...
		flexTable.setWidget(22, 0, lblNoteSubtract);
		flexTable.getFlexCellFormatter().setColSpan(22, 0, 4);
